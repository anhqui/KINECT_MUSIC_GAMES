...
{
    public partial class Randomness : Form
    {
        ...
        private void Randomness_Load(object sender, EventArgs e)
        {
        ...
        private void closeGame_Tick(object sender, EventArgs e)
        {
            this.Close();
        }
