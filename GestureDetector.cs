...
/*
 * This class is responsible for the process of gesture detection.
 * Gesture Codes:
 * None                     : 0
 * Wave with left hand      : 1
 * Wave with right hand     : 2
 * Swipe with left hand     : 3
 * Swipe with right hand    : 4
 * UpDown with left hand    : 5
 * UpDown with right hand   : 6
 * Punch with left hand     : 7
 * Punch with right hand    : 8
 * Kick with left leg       : 9
 * Kick with right leg      : 10
 * Stop                     : 11
 */
