...
{
    public partial class Song4 : Form
    {
        ...
        private void Song4_Load(object sender, EventArgs e)
        {
        ...
        private void GesturHandler(object sender, EventArgs e)
        {
            switch (this._Detector.Gesture)
            {
                ...
                case 3:
                    ...
                    player.SoundLocation = "kick1.wav";
                    player.Play();
                    moved = true;
                ...
                case 9:
                    ...
                    player3.SoundLocation = "snare1.wav";
                    player3.Play();
                    moved = true;
                ...
                case 10:
                    ...
                    player4.SoundLocation = "snare1.wav";
                    player4.Play();
                    moved = true;
                    if (whatMove.Text.Equals(kick))
                        score++;
